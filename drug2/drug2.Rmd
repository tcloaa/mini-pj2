...
forest1 = randomForest(IC50s ~ . - Cell.lines, model_data, mtry = 8, importantce = TRUE) #p = 62, p^0.5 = 7.8
...
forest1 = randomForest(IC50s ~ . - Cell.lines, model_data, mtry = 62, importantce = TRUE)#p = 62
predict_value = predict(forest1, newdata = kaggle_data)
